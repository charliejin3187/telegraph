...
DONATE_STRING = """*Thanks for showing interest in donation.*

To donate and support me you can send *any amount* as you wish 😇

We are glad to Say that we accepts *Any type of Payment Methods*.😍"""
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN,reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="📌 Support Group", url="https://t.me/DXB_Support"), InlineKeyboardButton(text="🔖 Update Channel", url="https://t.me/DX_BotZ")],
                                                                                 [InlineKeyboardButton(text="Share & Support", url="https://t.me/share/url?url=Hai%20Friend%20%F0%9F%98%8D%2C%0AAm%20Introducing%20a%20Powerful%20%2A%2AGoogle%20Lens%20Bot%2C%2A%2A%20Which%20can%20Reverse%20Search%20a%20Image%20or%20a%20Sticker%20%E2%9D%A4%EF%B8%8F%0A%2A%2ABot%20Link%3A%2A%2A%20%40GoogleLens_Bot")]]))
    else:
        update.effective_message.reply_text("")
...
def donate(bot: Bot, update: Update):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 254318997 and DONATION_LINK:
            update.effective_message.reply_text("For Donations, you can contact "
                                                "[My Creator]({})".format(DONATION_LINK),
                                                parse_mode=ParseMode.MARKDOWN)
